...
import { LeagueResolverService } from "./features/leagues/league-resolver.service";
import { AuthComponent } from "./auth/components/auth/auth.component";
import { AuthGuard } from "./auth/guardians/auth.guard";
import { FavouriteLeaguesResolverService } from "./features/favourite/services/favourite-leagues-resolver.service";
...
const routes: Routes = [
  ...
  },
  {
    ...
    resolve: [
      /*FavouriteLeaguesResolverService*/
    ],
  },
  {
    path: "leagues",
